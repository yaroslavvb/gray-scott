...
function colorToString (color, forceCSSHex) {
  ...
  if (forceCSSHex || colorFormat === 'THREE_CHAR_HEX' || colorFormat === 'SIX_CHAR_HEX' || colorFormat === 'EIGHT_CHAR_HEX') {
    if (colorFormat === 'SIX_CHAR_HEX') {
      var str = color.hex.toString(16);
      while (str.length < 6) {
        str = '0' + str;
      }
      return '#' + str;
    } else if (colorFormat === 'EIGHT_CHAR_HEX') {
      return '#' + appendZero(color.hex.toString(16), 6) + appendZero(color.a.toString(16), 2);
    }
  ...
  conversions: {
    ...
    EIGHT_CHAR_HEX: {
      read: function read(original) {
        ...
        var rgba = parseInt('0x' + test[1].toString(), 0);
        return {
          space: 'HEX',
          hex: rgba >> 8 & 0xFFFFFF,
          a: rgba & 0xFF
...
var NumberControllerBox = function (_NumberController) {
  ...
  function NumberControllerBox(object, property, params) {
    ...
    _this2.__truncationSuspended = true;
    ...
    function _getIncrement() {
      ...
      console.log("c aret:%d dot: %d, inc:%f", caret, dotIndex, inc);
      return inc;
    }
    _this2.__input = document.createElement('input');
    _this2.__input.setAttribute('type', 'text');
    ...
    dom.bind(_this2.__input, 'mouseup', onFocus);
...
var ColorController = function (_Controller) {
  ...
  function ColorController(object, property) {
    ...
    alphaGradient(_this2.__alpha_field);
    ...
    dom.bind(_this2.__alpha_field, 'mousedown', fieldDownA);
    dom.bind(_this2.__alpha_field, 'touchstart', fieldDownA);
    ...
    function setA(e) {
      ...
      var fieldRect = _this.__alpha_field.getBoundingClientRect();
